  ...
  <div class="org-page page-full-height" :class="{ 'day-mode': !nightMode }">
    ...
    <div class="archive-header">
      ...
      <div class="search-wrap">
        ...
        <input v-model="searchQuery" name="search" class="search-input" placeholder="이름, 직책, 이메일 검색..." />
      </div>

      <div class="plus-wrap">
        <input id="csv-import-input" name="csv-import-input" ref="csvImportInput" type="file" accept=".csv" style="display:none" @change="handleCSVFile" />
          ...
          <div class="app-modal-body">
            ...
            <div class="app-modal-field-row">
              ...
              <div class="app-modal-field">
                ...
                <input id="add-member-email" v-model="addForm.email" autocomplete="off" class="app-modal-input" placeholder="example@company.com" />
              </div>
            </div>
            ...
            <div class="app-modal-field-row">
              <div class="app-modal-field">
                ...
                <input id="add-member-company" v-model="addForm.company" autocomplete="off" class="app-modal-input" placeholder="예: 워크메이트" />
              </div>
              <div class="app-modal-field">
                <label for="add-member-department">부서명</label>
                <input id="add-member-department" v-model="addForm.department" autocomplete="off" class="app-modal-input" placeholder="예: 전략기획팀" />
              </div>
            </div>
            <!-- Position -->
            <div class="app-modal-field-row">
              ...
              <div class="app-modal-field">
                ...
                <input id="add-member-password" v-model="addForm.password" type="password" autocomplete="new-password" class="app-modal-input"
          ...
          <div class="app-modal-body">
            <div class="app-modal-field-row">
              <div class="app-modal-field">
                ...
                <input id="edit-member-name" v-model="editModal.name" class="app-modal-input" placeholder="홍길동" />
              </div>
              <div class="app-modal-field">
                <label for="edit-member-email">이메일</label>
                <input id="edit-member-email" :value="editModal.email" class="app-modal-input" disabled style="background:var(--surface);color:var(--dark-muted)" />
              </div>  
            </div>
            <div v-if="auth.user?.role === 'SYSTEM_ADMIN'" class="app-modal-field">
              <label for="edit-member-role">역할 (관리자 전용)</label>
              <select id="edit-member-role" v-model="editModal.role" class="app-modal-input">
            ...
            <div class="app-modal-field-row">
              <div class="app-modal-field">
                <label for="edit-member-company">회사명</label>
                <input id="edit-member-company" v-model="editModal.company" class="app-modal-input" placeholder="예: 워크메이트" />
              </div>
              <div class="app-modal-field">
                <label for="edit-member-department">부서명</label>
                <input id="edit-member-department" v-model="editModal.department" class="app-modal-input" placeholder="예: 전략기획팀" />
              </div>
            </div>
            <div class="app-modal-field-row">
              <div class="app-modal-field">
                <label for="edit-member-position">직책</label>
                <input id="edit-member-position" v-model="editModal.position" class="app-modal-input" placeholder="예: 팀장" />
              </div>
            </div>
          </div>
          <div class="app-modal-footer">
