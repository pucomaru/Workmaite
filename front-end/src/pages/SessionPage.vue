...
const DEMO_MEETINGS = [
  {
    id: 'dm-1', title: '전략기획위원회',
    sessions: [
      { id: 's-1', title: '2025 전략 수립 1차', status: 'scheduled', scheduled_at: '2025-05-20T10:00' },
      { id: 's-2', title: '예산 계획 검토', status: 'ended', scheduled_at: '2025-04-15T14:00' },
    ],
  },
  {
    id: 'dm-2', title: '운영위원회',
    sessions: [
      { id: 's-3', title: '운영 현황 보고', status: 'scheduled', scheduled_at: '2025-05-22T09:00' },
    ],
  },
  {
    id: 'dm-3', title: '개발팀 주간회의',
    sessions: [
      { id: 's-4', title: '스프린트 계획 - W20', status: 'scheduled', scheduled_at: '2025-05-13T10:30' },
      { id: 's-5', title: '기술 검토 - W19', status: 'ended', scheduled_at: '2025-05-06T10:30' },
    ],
  },
  {
    id: 'dm-4', title: '마케팅 전략회의',
    sessions: [
      { id: 's-6', title: 'Q2 캠페인 기획', status: 'scheduled', scheduled_at: '2025-05-21T15:00' },
    ],
  },
  {
    id: 'dm-5', title: '인사위원회',
    sessions: [
      { id: 's-7', title: '채용 심사 2차', status: 'scheduled', scheduled_at: '2025-05-19T11:00' },
    ],
  },
]
...
function selectMeeting(m) {
  expandedMeetingId.value = expandedMeetingId.value === m.id ? null : m.id
}
