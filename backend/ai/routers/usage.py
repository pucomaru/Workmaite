...
from context_types import section_of as _section_of  # noqa: E402
                ...
                "by_context": [
                    {
                        ...
                        "total_tokens": by_mc.get(r.model_name, {})
                        .get(s, {})
                        .get("total_tokens", 0),
                        "cost": round(
                            by_mc.get(r.model_name, {}).get(s, {}).get("cost", 0.0), 6
                        ),
                    }
