...
/**
 * 안건 관련 API
 * POST   /api/v1/meetings/{meetingId}/agendas/extract - AI 안건 추출
 * GET    /api/v1/meetings/{meetingId}/agendas         - 안건 목록 조회
 * POST   /api/v1/meetings/{meetingId}/agendas         - 안건 생성
 * GET    /api/v1/agendas/{agendaId}                   - 안건 상세 조회
 * PATCH  /api/v1/agendas/{agendaId}                   - 안건 수정
 * DELETE /api/v1/agendas/{agendaId}                   - 안건 삭제
 * PATCH  /api/v1/agendas/{agendaId}/assignment        - 안건 담당자 배정
 */
@RestController
