...
public class MinutesController {
  ...
  public ResponseEntity<ApiResponse<MinutesResponse>> generateMinutes(
      @PathVariable Integer sessionId, @Valid @RequestBody MinutesGenerateRequest request) {
  ...
  // 회의록 조회
  @GetMapping
  public ResponseEntity<ApiResponse<MinutesResponse>> getMinutes(@PathVariable Integer sessionId) {
  ...
  public ResponseEntity<ApiResponse<MinutesResponse>> updateMinutes(
      @PathVariable Integer sessionId, @Valid @RequestBody MinutesUpdateRequest request) {
  ...
  public ResponseEntity<ApiResponse<MinutesSummaryResponse>> getSummary(
      @PathVariable Integer sessionId, @Valid @RequestBody MinutesSummaryRequest request) {
  ...
  public ResponseEntity<ApiResponse<MinutesResponse>> confirmMinutes(
      @PathVariable Integer sessionId, @Valid @RequestBody MinutesConfirmRequest request) {
