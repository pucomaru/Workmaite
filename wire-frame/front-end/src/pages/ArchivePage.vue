...
.agent-neo4j-badge { display:inline-flex;align-items:center;gap:3px;background:#00ab36;color:#fff;font-size:9px;font-weight:800;padding:2px 6px 2px 5px;border-radius:4px;letter-spacing:.03em;flex-shrink:0; }
